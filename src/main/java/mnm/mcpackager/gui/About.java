...
public class About extends JDialog {
    ...
    private About(final JFrame parent) {
        ...
        JComponent tabAbout = new JPanel();
        {
            ...
            tabAbout.setBorder(new EmptyBorder(5, 5, 5, 5));
            {
                ...
                {
                    JLabel lblSda = new JLabel(
                            "<html><ol>" + "<li>Run MCPatcher on the desired version of Minecraft.</li>"
                                    + "<li>In the repackager and click the <em>Select Jar</em> button and select your patched jar.</li>"
                                    + "<li>Click the <em>Repackage</em> button and wait for the program to finish.</li>"
                                    + "<br/> If any issues arrise, a dialog will pop up with a short description of what went wrong."
                                    + "</ol></html>");
    ...
    public class LinkAdapter extends MouseAdapter {
        ...
        public void mouseEntered(MouseEvent e) {
            ...
            ((JLabel) e.getComponent()).setText("<HTML><U>" + original + "</U></HTML>");
        }
